...
import {
  user_MTN_subscription,
  userSubscriptionCheck,
  user_AT_subscription,
} from '../api/UserAPI';
...
const SubscriptionModal = ({
  ...
  const handleSubscribe = async () => {
    ...
    const alertTitle = isPaymentCheck
    ...
    if (result['success'] === 'true') {
      ...
      setTimeout(async () => {
        ...
        const subscriptionStatus =
          verifySubscription['data'] != null
            ? verifySubscription['data'].subscription_status.toLowerCase()
            : 'N/A'.toLowerCase();
