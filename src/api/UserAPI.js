...
export const allUserData = async subscriberMsisdn => {
  ...
  return {
    ...
    message: loginResponse['message'],
    subscriber:
      loginResponse['data'] != null ? loginResponse['data'].user : null,
    movies: loginResponse['data'] != null ? loginResponse['data'].movies : null,
    favorites:
      loginResponse['data'] != null ? loginResponse['data'].favorites : null,
    watchList:
      loginResponse['data'] != null
        ? loginResponse['data'].watch_history
        : null,
  };
};
...
export const user_MTN_subscription = async payload => {
  ...
  try {
    ...
    if (!response.ok) {
      return {
        success: 'false',
        message: `MTN subscription failed`,
      };
    }
...
export const user_MTN_unSubscription = async payload => {
  ...
  try {
    ...
    if (!response.ok) {
      return {
        success: 'false',
        message: `MTN unsubscription failed`,
      };
    }
...
//AT subscription
export const user_AT_subscription = async msisdn => {
  let payload = {
    msisdn: msisdn,
    network: userData.network.airtel,
    plan_type: userData.AT_plan_type,
    product_id: userData.AT_product_id,
    amount: userData.AT_amount,
  };
  ...
  const url = `${BaseURL}/at/subscribe`;
  ...
  try {
    ...
    if (!response.ok) {
      return {
        success: 'false',
        message: `AT subscription failed`,
      };
    }
...
// export const movieSubscription = (msisdn) => {
